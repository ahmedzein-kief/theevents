class AppStrings {
  ...
  static const String redeemThirdLine = "After the transaction, the recipient will receive their eGift Card Code via EMAIL";
  static const String redeemForthLine = "The recipient can redeem the gift amount by clicking on the link and entering the code";
  ...
  static const String vendorContactHeading = "Preview the agreement and make sure all the information is accurate. then continue to the payment.";
  ...
  static const String paymentDone = "Our team is reviewing your documents. You’ll get a notification about your vendor approval status soon. Once approved, we’ll email you the contract for your signature";
  static const String paymentThanks = "Thank you for choosing to partner with us. We look forward to a successful collaboration";
