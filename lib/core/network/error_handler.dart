...
class ResponseMessage {
  static const String SUCCESS = ApiConstants.success; // success with data
  static const String NO_CONTENT = ApiConstants.success; // success with no data (no content)
  static const String BAD_REQUEST = ApiConstants.badRequestError; // failure, API rejected request
  static const String UNAUTHORISED = ApiConstants.unauthorizedError; // failure, user is not authorised
  static const String FORBIDDEN = ApiConstants.forbiddenError; //  failure, API rejected request
  static const String INTERNAL_SERVER_ERROR = ApiConstants.internalServerError; // failure, crash in server side
  static const String NOT_FOUND = ApiConstants.notFoundError; // failure, crash in server side

  // local status code
  static const String CONNECT_TIMEOUT = ApiConstants.timeoutError;
  static const String CANCEL = ApiConstants.defaultError;
  static const String RECEIVE_TIMEOUT = ApiConstants.timeoutError;
  static const String SEND_TIMEOUT = ApiConstants.timeoutError;
  static const String CACHE_ERROR = ApiConstants.cacheError;
  static const String NO_INTERNET_CONNECTION = ApiConstants.noInternetError;
  static const String UNKNOWN = ApiConstants.defaultError;
}
