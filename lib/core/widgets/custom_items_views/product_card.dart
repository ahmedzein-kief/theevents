                    ...
                    children: [
                      ...
                      Positioned(
                        ...
                        child: Row(
                          ...
                          children: [
                            Container(
                              padding: const EdgeInsets.only(left: 4, right: 8, top: 1, bottom: 1),
                              color: Colors.white,
                              child: Row(
                      ...
                      child: GestureDetector(
                        ...
                        child: Container(
                          ...
                          child: SvgPicture.asset(
                            height: 18,
                            width: 18,
                            widget.isOutOfStock ? AppStrings.outOfStock : AppStrings.itemAddToCart,
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                       ...
                       if(widget.storeName != null) Padding(
                          padding: const EdgeInsets.only(top: 5),
                          child: Text(
                           'By ${widget.storeName}' ,
                            maxLines: 1,
