  ...
  Widget build(BuildContext context) {
    return MultiProvider(
      providers: [
        ...
        ChangeNotifierProvider(create: (_) => FeaturedCategoriesDetailProvider()),
        ...
        ChangeNotifierProvider(create: (_) => PaymentMethodProviderGiftCard()),
        ...
        ChangeNotifierProvider(create: (_) => SubMitCheckoutInformationProvider()),
        ...
        ChangeNotifierProvider(create: (_) => VendorGetProductVariationsViewModel()),
        ChangeNotifierProvider(create: (_) => VendorSetDefaultProductVariationViewModel()),
        ChangeNotifierProvider(create: (_) => VendorGetSelectedAttributesViewModel()),
        ...
        ChangeNotifierProvider(create: (_) => VendorCreateUpdateVariationViewModel()),

        /// vendor orders
        ChangeNotifierProvider(create: (_) => VendorGetOrdersViewModel()),
        ChangeNotifierProvider(create: (_) => VendorGetOrderDetailsViewModel()),
        ChangeNotifierProvider(create: (_) => VendorGenerateOrderInvoiceViewModel()),
        ...
        ChangeNotifierProvider(create: (_) => VendorGetPackageGeneralSettingsViewModel()),
        ChangeNotifierProvider(create: (_) => VendorCreatePackageViewModel()),
        ChangeNotifierProvider(create: (_) => VendorDeletePackageViewModel()),
        ChangeNotifierProvider(create: (_) => VendorGetViewPackageViewModel()),

        /// withdrawals
        ChangeNotifierProvider(create: (_) => VendorWithdrawalsViewModel()),
        ChangeNotifierProvider(create: (_) => VendorShowWithdrawalViewModel()),


        /// customer
        ChangeNotifierProvider(create: (_) => CustomerUploadProfilePicViewModel()),
        ChangeNotifierProvider(create: (_) => CustomerGetProductReviewsViewModel()),
        ChangeNotifierProvider(create: (_) => CustomerDeleteReviewViewModel()),
...
ThemeData lightTheme = ThemeData(
    ...
    appBarTheme: AppBarTheme(backgroundColor: AppColors.bgColor, elevation: 0.5, shadowColor: Colors.grey, titleTextStyle: TextStyle(color: Colors.black)));
...
ThemeData darkTheme = ThemeData(
    ...
    textSelectionTheme: TextSelectionThemeData(cursorColor: AppColors.peachyPink, selectionColor: AppColors.peachyPink, selectionHandleColor: AppColors.peachyPink),
    bottomNavigationBarTheme: BottomNavigationBarThemeData(backgroundColor: Colors.grey.withOpacity(0.5)),
    scaffoldBackgroundColor: Colors.black,
    appBarTheme: AppBarTheme(backgroundColor: Colors.black, elevation: 0.5, shadowColor: AppColors.lightCoral, titleTextStyle: TextStyle(color: Colors.white)));
