...
class CartItem {
  ...
  factory CartItem.fromJson(Map<String, dynamic> json) {
    return CartItem(
      ...
      tax: (json['tax'] is String ? double.tryParse(json['tax']) ?? 0.0 : (json['tax'] is num ? json['tax'].toDouble() : 0.0)),
      subtotal: (json['subtotal'] is String ? double.tryParse(json['subtotal']) ?? 0.0 : (json['subtotal'] is num ? json['subtotal'].toDouble() : 0.0)),
...
class Options {
  ...
  factory Options.fromJson(Map<String, dynamic> json) {
    var taxClassesMap = json['taxClasses'] as Map<String, dynamic>? ?? {};

    Map<String, double> taxClasses = {};
...
class ProductDetails {
  ...
  factory ProductDetails.fromJson(Map<String, dynamic> json) {
    return ProductDetails(
      ...
      // Updated line
      brand: (json['brand'] != null && json['brand'] is Map<String, dynamic>) ? Brand.fromJson(json['brand']) : null, // Updated line
    );
  }
}
...
class Prices {
  ...
  factory Prices.fromJson(Map<String, dynamic> json) {
    return Prices(
      frontSalePrice:
          (json['front_sale_price'] is String ? double.tryParse(json['front_sale_price']) ?? 0.0 : (json['front_sale_price'] is num ? json['front_sale_price'].toDouble() : 0.0)),
      price: (json['price'] is String ? double.tryParse(json['price']) ?? 0.0 : (json['price'] is num ? json['price'].toDouble() : 0.0)),
