...
class CheckoutData {
  ...
  factory CheckoutData.fromJson(Map<String, dynamic> json) => CheckoutData(
        ...
        orderAmount: json['orderAmount'] is double
            ? json['orderAmount'].toStringAsFixed(2)
            : json['orderAmount'],
        ...
        sessionCheckoutData: json['sessionCheckoutData'] == null
            ? null
            : SessionCheckoutData.fromJson(json['sessionCheckoutData']),
...
class Shipping {
  ...
  factory Shipping.fromJson(Map<String, dynamic> json) => Shipping(
        shippingDefault: Map.from(json['default']!)
            .map((k, v) => MapEntry<String, Default>(k, Default.fromJson(v))),
      );
...
class Address {
  ...
  factory Address.fromJson(Map<String, dynamic> json) => Address(
        ...
        locationCountry: json['location_country'] == null
            ? []
            : List<dynamic>.from(json['location_country']!.map((x) => x)),
        locationState: json['location_state'] == null
            ? []
            : List<dynamic>.from(json['location_state']!.map((x) => x)),
        locationCity: json['location_city'] == null
            ? []
            : List<dynamic>.from(json['location_city']!.map((x) => x)),
      );
  dynamic id;
  String? name;
  String? email;
...
class FormattedPrices {
  ...
  factory FormattedPrices.fromRawJson(String str) =>
      FormattedPrices.fromJson(json.decode(str));
...
class SessionCheckoutData {
  ...
  factory SessionCheckoutData.fromRawJson(String str) =>
      SessionCheckoutData.fromJson(json.decode(str));
        ...
        marketplace: (json['marketplace'] is Map)
            ...
            : (json['marketplace'] is List && json['marketplace'].isNotEmpty)
                ? Marketplace.fromJson(
                    {'0': json['marketplace'].first}) // Convert List to Map
                : null,
...
class ShippingDetails {
  ...
  factory ShippingDetails.fromJson(Map<String, dynamic> json) =>
      ShippingDetails(
        ...
        address: json['address'],
        zipCode: json['zip_code'],
        createdOrder: json['created_order'] == null
            ? null
            : DateTime.parse(json['created_order']),
        ...
        createdOrderProduct: json['created_order_product'] == null
            ? null
            : DateTime.parse(json['created_order_product']),
