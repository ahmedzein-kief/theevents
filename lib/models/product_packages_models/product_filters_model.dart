...
class ProductFiltersModel {
  ...
  factory ProductFiltersModel.fromJson(Map<dynamic, dynamic> json) => ProductFiltersModel(
        rand: json["rand"] ?? 0,
        categoryRequest: json["categoryRequest"] != null ? List<dynamic>.from(json["categoryRequest"].map((x) => x)) : [],
        brands: json["brands"] != null ? List<FilterBrand>.from(json["brands"].map((x) => FilterBrand.fromJson(x))) : [],
        maxPrice: json["max_price"] ?? 0,
        categoryId: json["category_id"] ?? 0,
        categories: json["categories"] != null ? List<ProductFiltersModelCategory>.from(json["categories"].map((x) => ProductFiltersModelCategory.fromJson(x))) : [],
        tags: json["tags"] != null ? List<Tag>.from(json["tags"].map((x) => Tag.fromJson(x))) : [],
        attributesSet: json["attributeSets"] != null ? List<AttributeSet>.from(json["attributeSets"].map((x) => AttributeSet.fromJson(x))) : [],
      );
...
class FilterBrand {
  ...
  factory FilterBrand.fromJson(Map<dynamic, dynamic> json) => FilterBrand(
        ...
        categories: List<BrandCategory>.from(json["categories"].map((x) => BrandCategory.fromJson(x))),
...
final referenceTypeValues = EnumValues(
  {"Botble\\Ecommerce\\Models\\Brand": ReferenceType.BOTBLE_ECOMMERCE_MODELS_BRAND, "Botble\\Ecommerce\\Models\\ProductTag": ReferenceType.BOTBLE_ECOMMERCE_MODELS_PRODUCT_TAG},
);
