...
class ChangePasswordProvider with ChangeNotifier {
  ...
  Future<void> changePassword(String token, ChangePasswordRequest request, BuildContext context) async {
    final urlChangePassword = ApiEndpoints.changePassword;
...
class ChangePasswordRequest {
  ...
  ChangePasswordRequest({required this.oldPassword, required this.password, required this.password_confirmation});
