class VendorApiEndpoints {
  static const String baseUrl = 'https://api.staging.theevents.ae/api/v1/vendor/';
  static const String baseUrlSettings = 'https://api.staging.theevents.ae/api/v1/';
  static const String imageBaseURL = 'https://api.staging.theevents.ae/storage/';
