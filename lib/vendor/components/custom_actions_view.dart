...
class CustomIconContainer extends StatelessWidget {
  ...
  final double fixedHeight; // Fixed height for the container
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          border: Border.all(
            color: (borderColor ?? Colors.transparent).withOpacity(0.5), // Border color (transparent if not provided)
        ...
        child: Row(
          ...
          children: [
            ...
            Text(
              ...
              // Center align text
              style: GoogleFonts.inter(fontSize: 12, color: isBackgroundColored ? Colors.white : Theme.of(context).colorScheme.onPrimary.withAlpha(400)
                  // color: Colors.black.withAlpha(400),
                  ),
            ),
            SizedBox(width: 4),
            if (suffixIcon != null) Icon(suffixIcon, color: isBackgroundColored ? Colors.white : Theme.of(context).colorScheme.onPrimary, size: 16), // Suffix Icon
          ],
        ),
      ),
    );
