...
class CustomEditableTextField extends StatefulWidget {
  ...
  double? fieldHeight;
   ...
   CustomEditableTextField({super.key, required this.placeholder, required this.quillController, this.borderRadius,this.showToolBar = true,this.fieldHeight = 500});
...
class _CustomEditableTextFieldState extends State<CustomEditableTextField> {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Container(
        decoration: BoxDecoration(border: Border.all(color: Colors.grey, width: 0.5), borderRadius: BorderRadius.circular(widget.borderRadius ?? 10)),
        child: Column(
          children: [
          if(widget.showToolBar == true)  Column(
              children: [
                QuillSimpleToolbar(
                  ...
                  config: const QuillSimpleToolbarConfig(
                      ...
                      decoration: BoxDecoration(shape: BoxShape.circle, border: Border(top: BorderSide(color: Colors.black))),
