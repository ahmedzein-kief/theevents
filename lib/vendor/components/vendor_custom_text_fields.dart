            ...
            decoration: InputDecoration(
              ...
              prefixIcon: (widget.prefixIcon != null || widget.prefixText != null)
                  ? Container(
                      ...
                      margin: const EdgeInsets.only(left: 1, top: 1, bottom: 1, right: 8),
                      decoration: BoxDecoration(
                        color: widget.isPrefixFilled && widget.prefixContainerColor != null ? widget.prefixContainerColor : Colors.transparent,
                        ...
                        children: [
                          ...
                          if (widget.prefixIcon != null)
                            Padding(
                                ...
                                child: IconButton(
                                  icon: Icon(widget.prefixIcon, color: widget.prefixIconColor ?? Colors.grey),
              ...
              suffixIcon: widget.suffixWidget != null
                  ...
                  : widget.suffixIcon != null
                      ? IconButton(
                          icon: Icon(widget.suffixIcon, color: widget.suffixIconColor ?? Colors.grey, size: 18),
                          onPressed: widget.onIconPressed,
                        )
                      : null,
            ),
