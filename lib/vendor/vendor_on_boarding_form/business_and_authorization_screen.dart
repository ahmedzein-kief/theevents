...
class _BusinessAndAuthorizationScreenState extends State<BusinessAndAuthorizationScreen> {
  ...
  Future<BusinessSignatoryResponse?> updateBusinessSignatoryData(
    ...
    final provider = Provider.of<VendorSignUpProvider>(context, listen: false);
    var response = await provider.updateBusinessSignatoryData(context, boiData, asiData);
    return response;
  }
                    ...
                    Row(
                      children: [
                        Expanded(
                          ...
                          title: Text("Are you business owner", style: vendorBusinessInfo()),
                          value: 0,
                        ...
                        Expanded(
                            child: RadioListTile<int>(
                          title: Text("Are you an authorized signatory?", style: vendorBusinessInfo()),
                          activeColor: Colors.black,
                          value: 1,
                          groupValue: _radioValue,
                          onChanged: (int? value) {
