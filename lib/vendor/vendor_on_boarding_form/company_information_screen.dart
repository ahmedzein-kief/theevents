...
class _CompanyInformationScreenState extends State<CompanyInformationScreen> {
  ...
  Future<void> getAllMetaData() async {
    ...
    if (response != null) {
      ...
      ciModel.companyCountry = _countryController.text = findCountryNameUsingCode(response.data["company_country"] ?? '');
      ciModel.tradingLicenseExpiryDate = _tradeLicenseNumberExpiryController.text = response.data["trading_license_expiry"] ?? '';
  ...
  Future<CompanyInfoResponse?> updateCompanyInfoData(
    ...
    final provider = Provider.of<VendorSignUpProvider>(context, listen: false);
    var response = await provider.updateCompanyInfoData(context, ciData);
    return response;
  }
                            ...
                            child: Padding(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  VendorCustomTextFields(
                                      labelText: 'Company Category Type',
                                      hintText: 'Please select CC type',
                                      textStar: " *",
                                      ...
                                      onIconPressed: () async {
                                        final categoryType = await showCompanyCategoryType(context, _companyCategoryController.text);
                                  ...
                                  VendorCustomTextFields(
                                    labelText: 'Upload Trade License (pdf)',
                                    hintText: 'No file chosen',
                                    textStar: " *",
                                  ...
                                  VendorCustomTextFields(
                                    labelText: 'Trade License Number Expiry Date',
                                    hintText: 'yyyy-MM-dd',
                                    textStar: " *",
                                    ...
                                    onIconPressed: () async {
                                      var result = await showDatePickerDialog(
                                        context,
                                        "yyyy-MM-dd",
                                      );
                                      if (result != null) {
                                  ...
                                  VendorCustomTextFields(
                                    labelText: 'NOC/POA (If Applicable - pdf)',
                                    hintText: 'No file chosen',
                                    textStar: "",
                                  ...
                                  VendorCustomTextFields(
                                    labelText: 'Vat Certificate (If Applicable - pdf)',
                                    hintText: 'No file chosen',
                                    textStar: "",
