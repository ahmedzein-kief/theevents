...
class _VendorLoginInfoScreenState extends State<VendorLoginInfoScreen> {
  int selectedIndex =
      0; // The current selected index (first container by default)
  ...
  void initState() {
    ...
    _companyMobileNumberFocusNode
        .addListener(() => _scrollToField(_companyMobileNumberFocusNode));
    super.initState();
  }
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    VendorCustomTextFields(
                                      ...
                                      validator:
                                          Validator.vendorPasswordValidation,
