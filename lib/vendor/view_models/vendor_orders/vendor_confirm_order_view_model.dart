...
class VendorConfirmOrderViewModel with ChangeNotifier {
  String? _token;
  ...
  Future<bool> vendorConfirmOrder({required dynamic orderID, required BuildContext context}) async {
    try {
      setLoading(true);
      ...
      CommonPostRequestModel response = await _myRepo.vendorConfirmOrder(headers: headers, orderID: orderID.toString());
