...
class VendorDeleteOrderViewModel with ChangeNotifier {
  String? _token;
  ...
  Future<bool> vendorDeleteOrder({required dynamic orderID, required BuildContext context}) async {
    try {
      setLoading(true);
      ...
      CommonPostRequestModel response = await _myRepo.vendorDeleteOrder(headers: headers, orderID: orderID.toString());
