...
class VendorSendConfirmationEmailViewModel with ChangeNotifier {
  String? _token;
  ...
  Future<bool> vendorSendConfirmationEmail({required dynamic orderID, required BuildContext context}) async {
    try {
      setLoading(true);
      ...
      CommonPostRequestModel response = await _myRepo.vendorSendConfirmationEmail(headers: headers, orderID: orderID.toString());
