...
class VendorGetPackageGeneralSettingsViewModel with ChangeNotifier {
  ...
  ApiResponse<VendorGetPackageGeneralSettingsModel>
  ...
  Future<bool> vendorGetPackageGeneralSettings() async {
    try {
      ...
      final VendorGetPackageGeneralSettingsModel response =
          await _myRepo.vendorGetPackageGeneralSettings(headers: headers);
      setPackageGeneralSettingsApiResponse = ApiResponse.completed(response);
      setLoading(false);
      return true;
    } catch (error) {
      setPackageGeneralSettingsApiResponse =
