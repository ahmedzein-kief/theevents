...
class VendorDeletePackageViewModel with ChangeNotifier {
  String? _token;
  ...
  Future<bool> vendorDeletePackage({required dynamic packageID, required BuildContext context}) async {
    try {
      setLoading(true);
      ...
      CommonPostRequestModel response = await _myRepo.vendorDeletePackage(headers: headers, packageID: packageID.toString());
