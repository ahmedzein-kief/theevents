...
class VendorGenerateAllProductVariationsViewModel with ChangeNotifier {
  ...
  Future<bool> vendorGenerateAllProductVariations({required dynamic productID, required BuildContext context}) async {
    try {
      setLoading(true);
      ...
      CommonPostRequestModel response = await _myRepo.vendorGenerateAllProductVariations(headers: headers, productID: productID.toString());
