...
class VendorSetDefaultProductVariationViewModel with ChangeNotifier {
  ...
  Future<bool> vendorSetDefaultProductVariation({
    required productVariationID,
    ...
    try {
      ...
      final CommonPostRequestModel response = await _myRepo.vendorSetDefaultProductVariation(
        headers: headers,
