...
class VendorSetDefaultProductVariationViewModel with ChangeNotifier {
  String? _token;
  ...
  Future<bool> vendorSetDefaultProductVariation({required dynamic productVariationID, required BuildContext context}) async {
    try {
      setLoading(true);
      ...
      CommonPostRequestModel response = await _myRepo.vendorSetDefaultProductVariation(headers: headers, productVariationID: productVariationID.toString());
