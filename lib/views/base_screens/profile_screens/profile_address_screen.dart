...
class _ProfileAddressScreenState extends State<ProfileAddressScreen> {
  ...
  void _formPageAddress(BuildContext context, CustomerRecords? customerAddress) {
    ...
    if (customerAddress != null) {
      ...
      _countryController.text = findCountryNameUsingCode(customerAddress.country ?? '');
                        ...
                        children: [
                          Column(
                            ...
                            children: [
                              ...
                              if (!provider.isLoading && provider.addresses.isNotEmpty) // Check if addresses are available
                                ListView.builder(
                                        ...
                                        children: <Widget>[
                                          address.isDefault == 1
                                              ? Container(
                                                  ...
                                                  child: Text('Default Address', style: GoogleFonts.inter(color: Colors.white, fontSize: 14, fontWeight: FontWeight.w200)))
                                              : SizedBox.shrink(),
                                          Row(
                                            mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                            ...
                                            children: <Widget>[
                                              ...
                                              Expanded(child: Align(alignment: Alignment.centerLeft, child: Text(address.name ?? 'ss', style: description(context)))),
                                            ],
                                          ),
                                          SizedBox(height: screenHeight * 0.01),
                                          Row(
                                            ...
                                            children: <Widget>[
                                              ...
                                              Expanded(child: Align(alignment: Alignment.centerLeft, child: Text(address.email ?? 'ss', style: description(context)))),
                                            ],
                                          ),
                                          SizedBox(height: screenHeight * 0.01),
                                          Row(
                                            ...
                                            children: <Widget>[
                                              ...
                                              Expanded(child: Align(alignment: Alignment.centerLeft, child: Text(address.phone ?? 'loading...', style: description(context)))),
                                            ],
                                          ),
                                          SizedBox(height: screenHeight * 0.01),
                                          Row(
                                            ...
                                            children: <Widget>[
                                              ...
                                              Expanded(
                                                  child: Align(alignment: Alignment.centerLeft, child: Text(address.fullAddress ?? 'loading...', style: description(context)))),
                                            ],
                                          ),
                                          SizedBox(height: screenHeight * 0.02),
                                          Row(
                                            ...
                                            children: <Widget>[
                                              GestureDetector(
                                                onTap: () async {
                                                  _formPageAddress(context, address);
                                                },
                                                child: Text(
                                                  "Edit",
                                                  style: TextStyle(
                                              ...
                                              GestureDetector(
                                                onTap: () async {
                                                  deleteItemAlertDialog(context: context,buttonColor: AppColors.peachyPink, onDelete: ()async{
                                                ...
                                                child: Container(height: 35, width: 35, child: Icon(CupertinoIcons.delete_simple, size: 25, color: Colors.red)),
                                              ),
                                            ],
                                          ),
                                        ],
                              ...
                              if (!provider.isLoading && provider.addresses.isEmpty)
                                Container(
                                  width: screenWidth,
                                  padding: EdgeInsets.only(left: screenHeight * 0.02, top: screenHeight * 0.01, bottom: screenHeight * 0.01),
