  ...
  Widget build(BuildContext context) {
    return Tab(
      child: Row(
        ...
        children: [
          Expanded(
            child: Text('Waiting For Review ${count != null ? "($count)" : ''}', style: reviewTabs(context),textAlign: TextAlign.center,),
          ),
        ],
      ),
    );
  ...
  Widget build(BuildContext context) {
    return Tab(
      child: Row(
        mainAxisAlignment: MainAxisAlignment.center,
        children: [
          Text('Reviewed ${count != null ? "($count)" : ''}', style: reviewTabs(context),textAlign: TextAlign.center,),
        ],
      ),
    );
  }
