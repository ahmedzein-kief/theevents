                  ...
                  children: [
                    VendorDataListBuilder(
                      onNoDataAvailable: Padding(
                        ...
                        child: Text('You do not have any products to review yet. Just shopping!', style: GoogleFonts.inter(fontSize: 20, color: AppColors.peachyPink, fontWeight: FontWeight.bold), textAlign: TextAlign.start,),
                      ),
                ...
                endWidget: RatingBar.builder(
                  ...
                  onRatingUpdate: (rating) async{
                    /// navigate to submit review view
                       await Navigator.of(context).push(CupertinoPageRoute(builder: (context)=>CustomerSubmitReviewView(currentRating: rating,productsAvailableForReview: record,)));
                  },
                ),
              ),
              kSmallSpace,
