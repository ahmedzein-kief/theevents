          ...
          child: Column(
            ...
            children: [
              ...
              Padding(
                ...
                child: Text('Cart Is Empty \n Start adding to your cart ', style: cartTextStyle(context), softWrap: true, textAlign: TextAlign.center),
              ),
              Padding(
                    ...
                    GestureDetector(
                      ...
                      child: Container(
                          ...
                          child: Row(
                            ...
                            mainAxisAlignment: MainAxisAlignment.center,
                            children: [
                              Text('Continue Shopping', softWrap: true, maxLines: 1, style: addToCartText(context)),
                            ],
                          )),
                    ),
                  ],
