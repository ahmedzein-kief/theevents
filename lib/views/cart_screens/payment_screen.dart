...
class _ShippingAddressScreenState extends State<PaymentScreen> {
  ...
  SessionCheckoutData? sessionCheckoutData = null;
  ...
  Future<String?> checkoutPayment(CheckoutResponse? checkoutData, Map<String, String> paymentMethod) async {
    ...
    return await provider.checkoutPaymentLink(
      context,
      widget.tracked_start_checkout ?? '',
      token ?? '',
      checkoutData,
  ...
  Future<bool> applyRemoveCouponCode(String couponCode, bool isApply) async {
    ...
    return await provider.applyRemoveCouponCode(
      context,
      widget.tracked_start_checkout ?? '',
      token ?? '',
      couponCode,
                  ...
                  child: SingleChildScrollView(
                    child: Column(
                      ...
                      children: [
                        ...
                        Divider(color: Theme.of(context).colorScheme.onPrimary.withOpacity(0.08)),
                        CustomTextFieldWithCoupon(
                          ...
                          onCouponApplyRemove: (couponCode, isApply) async {
                            if (couponCode.isNotEmpty) {
                              var result = await applyRemoveCouponCode(couponCode, isApply);
                              if (result) {
                                var resulData = await fetchData(sessionCheckoutData, initialShippingMethod);
                                if (resulData) {
                                  setState(() {
                                    if (isApply) {
                                      appliedCouponData = {
                ...
                Padding(
                  ...
                  child: AppCustomButton(
                    onPressed: () async {
                      ...
                      var checkoutURL = await checkoutPayment(provider.checkoutData, widget.paymentMethod);
                ...
                Padding(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      Text(
                        "${(value.checkoutData?.data?.formattedPrices?.subTotal ?? 'loading..').replaceAll("AED", "AED ")}",
                ...
                Padding(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      Text(
                        "${(value.checkoutData?.data?.formattedPrices?.tax ?? 'loading..').replaceAll("AED", "AED ")}",
                        style: cartSubtotal(context),
                      ),
                    ],
                  ),
                ...
                if (appliedCouponData['is_valid_coupon'])
                  Padding(
                    ...
                    child: Row(
                      mainAxisAlignment: MainAxisAlignment.spaceBetween,
                      children: [
                        Text(AppStrings.couponCodeText, style: cartSubtotal(context)),
                        Text(
                ...
                if (appliedCouponData['is_valid_coupon'])
                  Padding(
                    ...
                    child: Row(
                      mainAxisAlignment: MainAxisAlignment.spaceBetween,
                      children: [
                        Text(AppStrings.couponCodeAmount, style: cartSubtotal(context)),
                        Text(
                ...
                Padding(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      Text(
                          "${(value.checkoutData?.data?.formattedPrices?.shippingAmount ?? 'loading..').replaceAll("AED", "AED ")}",
                        style: cartSubtotal(context),
                      ),
                    ],
                  ),
                ...
                Padding(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      Text(
                          "${(value.checkoutData?.data?.formattedPrices?.orderAmount ?? 'loading..').replaceAll("AED", "AED ")}",
