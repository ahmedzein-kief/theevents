...
// import '../../core/widgets/custom_items_views/custom_text_field_save_address.dart';
...
//         if (widget.addressModel!.countryId.isNotEmpty) {
...
//       isDefault: selectedAddress?.isDefault == 1,
//     );
//   }
//
...
//     final provider = Provider.of<CustomerAddressProvider>(context, listen: false);
//     await provider.fetchCustomerAddresses(context);
//
...
//         AppUtils.showToast('Please select city and state');
//         return;
//       }
...
//         }
//       } else {
//         AppUtils.showToast(AppStrings.enterValidDetails.tr);
//       }
//     }
//   }
// }
