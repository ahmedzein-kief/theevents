...
class FeaturedBrandsItemsScreen extends StatefulWidget {
  ...
  @override
  State<FeaturedBrandsItemsScreen> createState() =>
      _FeaturedBrandsItemsScreenState();
}
                              ...
                              GridView.builder(
                                ...
                                itemBuilder: (context, index) {
                                  if (_isFetchingMorePackages &&
                                      index ==
                                          provider.recordsPackages.length) {
                                    return const Align(
                                      alignment: Alignment.center,
                                      child: Column(
                                        mainAxisAlignment:
                                  ...
                                  final product =
                                      provider.recordsPackages[index];
