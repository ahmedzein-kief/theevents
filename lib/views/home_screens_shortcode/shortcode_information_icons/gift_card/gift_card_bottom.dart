...
class GiftCardBottom extends StatelessWidget {
      ...
      children: [
        Padding(
          ...
          child: Column(
            ...
            children: [
              CachedNetworkImage(
                imageUrl: 'https://theevents.ae/assets/frontend/img/gift-card.png',
        ...
        Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Padding(padding: const EdgeInsets.only(top: 25), child: Text(softWrap: true, style: headingDescriptionStyleText(context), AppStrings.descriptionGiftCard))
            ],
          ),
        ),
        Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Padding(padding: const EdgeInsets.only(top: 25), child: Text(softWrap: true, style: headingDescriptionStyleText(context), AppStrings.termsAndConditions))
            ],
          ),
        ),
        Padding(
  ...
  Widget _buildCircleWithText(BuildContext context, String text) {
    return Padding(
