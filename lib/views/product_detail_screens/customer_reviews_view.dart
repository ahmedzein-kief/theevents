...
class CustomerReviews extends StatelessWidget {
  ...
  const CustomerReviews({super.key, required this.review, required this.customerReviews});
        ...
        children: [
          ...
          ListView.separated(
            ...
            itemBuilder: (context, index) {
              return _buildCustomerReview(customerReviews[index]);
            },
            separatorBuilder: (context, index) {
              return index != customerReviews.length - 1
                  ? const Padding(
  ...
  Widget _buildCustomerReview(CustomerReviewRecord review) {
    return Padding(
