  ...
  Widget build(BuildContext context) {
    return Material(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(color: AppColors.productBackground),
        child: SafeArea(
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                    ...
                    child: GestureDetector(
                      onTap: () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (context) => FullScreenImageView(imageUrl: widget.selectedImageUrl),
                          ),
                        );
                      },
                              ...
                              itemBuilder: (context, index) {
                                ...
                                return Padding(
                                  ...
                                  child: GestureDetector(
                                    ...
                                    child: Container(
                                      decoration: BoxDecoration(borderRadius: BorderRadius.circular(4), border: Border.all(color: Colors.black, width: 0.2)),
                                      child: ClipRRect(
                ...
                Padding(
                  padding: EdgeInsets.only(left: widget.screenWidth * 0.06, right: widget.screenWidth * 0.06),
                  child: Row(
